...
(* OASIS_START *)
(* DO NOT EDIT (digest: a6c8e5b069480f71813b517a8f62b4dd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Sean Proctor"; "Mike MacHenry"];
          homepage = None;
          synopsis = "MUD server";
          description = None;
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Template"; "Template_collection"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "(sg<\136\n\001\184\213\004y\026`\156\bp";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
